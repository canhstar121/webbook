...
class OrdersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.Orders.orders', compact('order', 'Count'));
    }
    ...
    public function create()
    {
        ...
        $users = $this->user->all();
        return view('Admin.Orders.action', compact('sanpham', 'users'));
    }
    ...
    public function show($id)
    {
        ...
        return view('Admin.Orders.action', compact('order', 'users', 'sanpham'));
    }
