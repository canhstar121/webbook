        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="main__title">
                        ...
                        <div class="main__title-wrap">
                            <!-- filter sort -->
                            <div class="filter">
                                <a href="{{ route('vaitro.create') }}" class="main__table-btn main__table-btn--edit">
                ...
                <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($data as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text">{{ $value->display_name }}</div>
                                            </td>
                                            <td>
                                                <div class="main__table-btns">
                                                    <a href="{{ route('vaitro.show',$value->id) }}" class="main__table-btn main__table-btn--edit">
                    ...
                    <!-- paginator -->
                    <div class="col-12">
                        {!! $data->render('Admin.inc.paginator') !!}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
...
@section('js')
    <script>
        function ModalDel(id, name) {
            $('#item').text(name);
            $('#clickDel').attr('action', '{{ url('vaitro') }}/'+id);
        }
    </script>
@stop
