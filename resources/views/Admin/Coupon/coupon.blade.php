        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-btns">
                                                    <a href="{{ route('giamgia.show',$value->id) }}" class="main__table-btn main__table-btn--edit">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                            <path
                                                                d="M5,18H9.24a1,1,0,0,0,.71-.29l6.92-6.93h0L19.71,8a1,1,0,0,0,0-1.42L15.47,2.29a1,1,0,0,0-1.42,0L11.23,5.12h0L4.29,12.05a1,1,0,0,0-.29.71V17A1,1,0,0,0,5,18ZM14.76,4.41l2.83,2.83L16.17,8.66,13.34,5.83ZM6,13.17l5.93-5.93,2.83,2.83L8.83,16H6ZM21,20H3a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Z" />
                                                        </svg>
                                                    </a>
                                                    <a href="#modal-delete" onclick="ModalDel('{{ $value->id }}','{{ $value->code }}')" class="main__table-btn main__table-btn--delete open-modal">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                            <path
                    ...
                    <!-- paginator -->
                    <div class="col-12">
                        {!! $coupon->render('Admin.inc.paginator') !!}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
...
@section('js')
    <script>
        function ModalDel(id, name) {
            $('#item').text(name);
            $('#clickDel').attr('action', '{{ url('giamgia') }}/'+id);
        }
    </script>
@stop
