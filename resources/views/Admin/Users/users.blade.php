            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="main__title">
                        ...
                        <span class="main__title-stat">Tổng {{ $userCount }}</span>

                        <div class="main__title-wrap">
                            <!-- filter sort -->
                            <div class="filter">
                                <a href="{{ route('taikhoan.create') }}" class="main__table-btn main__table-btn--edit">
                ...
                <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($users as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text">{{ $value->email }}</div>
                                            </td>
                                            <td>
                                                <div class="main__table-btns">
                                                    <a href="{{ route('taikhoan.show',$value->id) }}" class="main__table-btn main__table-btn--edit">
                    ...
                    <!-- paginator -->
                    <div class="col-12">
                        {!! $users->render('Admin.inc.paginator') !!}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
...
@section('js')
    <script>
        function ModalDel(id, name) {
            $('#item').text(name);
            $('#clickDel').attr('action', '{{ url('taikhoan') }}/'+id);
        }
    </script>
@stop
